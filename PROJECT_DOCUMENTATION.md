...
**eCard** is an Android mobile application built with **Kotlin** and **Jetpack Compose** that provides digital business card management functionality. The project uses modern Android architecture with clean separation of concerns following the MVVM pattern.
...
*Documentation generated for eCard - Kotlin Android Business Card App*
